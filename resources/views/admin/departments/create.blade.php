...
@section('content')
    ...
    <div class="card bg-base-100 shadow-sm border border-gray-100 rounded-2xl max-w-2xl">
        <div class="card-body">
            <form action="{{ isset($item) ? route('admin.departments.update', id) : route('admin.departments.store') }}" method="POST">
                @csrf
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="name" value="{{ old('name', name ?? '') }}" class="input input-bordered w-full bg-gray-50" />
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="description" value="{{ old('description', description ?? '') }}" class="input input-bordered w-full bg-gray-50" />
