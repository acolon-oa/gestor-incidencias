...
@section('content')
    ...
    <div class="card bg-base-100 shadow-sm border border-gray-100 rounded-2xl max-w-2xl">
        <div class="card-body">
            <form action="{{ isset($item) ? route('admin.announcements.update', id) : route('admin.announcements.store') }}" method="POST">
                @csrf
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="message" value="{{ old('message', message ?? '') }}" class="input input-bordered w-full bg-gray-50" />
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="type" value="{{ old('type', type ?? '') }}" class="input input-bordered w-full bg-gray-50" />
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="is_active" value="{{ old('is_active', is_active ?? '') }}" class="input input-bordered w-full bg-gray-50" />
