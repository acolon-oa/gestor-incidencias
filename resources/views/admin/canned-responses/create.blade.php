...
@section('content')
    ...
    <div class="card bg-base-100 shadow-sm border border-gray-100 rounded-2xl max-w-2xl">
        <div class="card-body">
            <form action="{{ isset($item) ? route('admin.canned-responses.update', id) : route('admin.canned-responses.store') }}" method="POST">
                @csrf
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="title" value="{{ old('title', title ?? '') }}" class="input input-bordered w-full bg-gray-50" />
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="content" value="{{ old('content', content ?? '') }}" class="input input-bordered w-full bg-gray-50" />
