    ...
    <div class="drawer drawer-open">
        ...
        <div class="drawer-content flex flex-col p-6">
            ...
            <nav class="flex items-center justify-between mb-6">
                <div class="text-xl font-bold">Good morning, Admin</div>
                <div class="flex items-center gap-3">
                    <button class="btn btn-primary flex items-center gap-2">
                        <x-heroicon-o-plus class="w-5 h-5" /><p>New Ticket</p>
                    </button>
                </div>
            </nav>
            ...
            <div class="overflow-x-auto bg-base-100 mt-5">
        ...
        <div class="drawer-side">
            <div class="flex min-h-full flex-col bg-base-100 w-64 p-4">

                <!-- Logo + Dashboard -->
                <section class="flex items-center mb-6 p-2">
                ...
                <ul class="menu w-full grow">
                    <li class="mb-2">
                        <a class="flex items-center gap-2 active hover:bg-gray-100 rounded-md p-2">
                            <x-heroicon-o-home class="w-5 h-5" />
                            <p>Dashboard</p>
                        </a>
                    </li>
                    <li class="mb-2">
                        <a class="flex items-center gap-2 hover:bg-gray-100 rounded-md p-2">
